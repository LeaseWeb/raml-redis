//
// Copy this file to your API Designer in the following folder:
//
// app/scripts/services
//
// Overwrite (backup) the original file first
// Change hte API_URL to the location of Raml-redis service

(function () {
  'use strict';

  var API_URL = 'http://YOUR_RAML_REDIS_URL:3000';
  angular.module('fs')
    .constant('FOLDER', 'folder')
    .factory('localStorageHelper', function ($http) {
      return {
        forEach: function(fn) {
	//PLAIN JQUERY
		jQuery.ajax({
